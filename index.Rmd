...
This document was last updated on `r Sys.Date()` and is a series of questions and answers relating to the Full Report taught in our MSc Research Methods course. 
...
* Procedure:
  * Upon reading your procedure a fellow researcher should be able to copy exactly what you did. This doesn't necessarily mean in terms of consents and debriefs, but those can be mentioned briefly ("After completing ...."), but really means what a participant will see and/or do when taking part in your study.
