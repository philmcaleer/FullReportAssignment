...
* Materials:
  ...
  * There is an example of a write-up of a questionnaire in the Week 7 slides for "An activity and presentation on detail in Methods with Phil" on Moodle.
* Procedure:
  ...
  * There is an example of a write-up of a Procedure in the Week 7 slides for "An activity and presentation on detail in Methods with Phil" on Moodle.
